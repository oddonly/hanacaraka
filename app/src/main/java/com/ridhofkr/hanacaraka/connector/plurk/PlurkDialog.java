...
public class PlurkDialog extends Dialog {
	...
	public PlurkDialog(Context context, String url, PDialogListener listener) {
		super(context);
		this.mUrl = url;
	...
	private void setUpTitle() {
		...
		Drawable icon = getContext().getResources().getDrawable(
				R.drawable.plurk_icon);

		mTitle = new TextView(getContext());

		mTitle.setText("Plurk");
		mTitle.setTextColor(Color.WHITE);
		mTitle.setTypeface(Typeface.DEFAULT_BOLD);
		mTitle.setBackgroundColor(0xFFf6d698);
	...
	private void setUpWebView() {
		...
		mWebView.setWebViewClient(new PlurkWebViewClient());
	...
	private class PlurkWebViewClient extends WebViewClient {
		...
		public boolean shouldOverrideUrlLoading(WebView view, String url) {
			if (url.startsWith(PlurkApp.CALLBACK_URL)) {
